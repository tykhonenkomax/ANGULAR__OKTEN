...
import {CommentsModule, PostsModule, UsersModule} from "../modules";
...
const routes:Routes =[
  {
    path:'',component:MainLayoutComponent, children:[
      ...
      {path:'comments',loadChildren:()=>import('.././modules/comments/comments.module').then(value => CommentsModule)}
    ]
